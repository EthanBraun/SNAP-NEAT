...
#define MUTATION_RATE_ADD_CONNECTION 0.08
#define MUTATION_RATE_PERTURB_WEIGHT_GENOME 0.90
#define MUTATION_RATE_SWAP_WEIGHT_CONNECTION 0.005
...
#define MUTATION_RATE_REMOVE_NODE 0.01
#define MUTATION_RATE_REMOVE_CONNECTION 0.03

#define CONNECTION_GENE_INITIAL_WEIGHT 0.0
#define CONNECTION_GENE_MAX_WEIGHT_PERTURBATION 0.80
...
#define POPULATION_MAX_GENOME_FITNESS 4000.0
#define POPULATION_SPECIES_CULL_RATE 0.5
#define POPULATION_SPECIES_MAX_STAGNATION 10000
#define POPULATION_TARGET_SPECIES_NUMBER 4
