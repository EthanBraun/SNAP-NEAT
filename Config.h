...
#define MUTATION_RATE_ADD_CONNECTION 0.17
#define MUTATION_RATE_PERTURB_WEIGHT_GENOME 0.90
#define MUTATION_RATE_SWAP_WEIGHT_CONNECTION 0.001
#define MUTATION_RATE_PERTURB_WEIGHT_CONNECTION 0.25
#define MUTATION_RATE_TOGGLE_NODE 0.02
#define MUTATION_RATE_TOGGLE_CONNECTION 0.02
#define MUTATION_RATE_REMOVE_NODE 0.06
#define MUTATION_RATE_REMOVE_CONNECTION 0.11

#define CONNECTION_GENE_INITIAL_WEIGHT 0.0
#define CONNECTION_GENE_MAX_WEIGHT_PERTURBATION 1.50
