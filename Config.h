...
#define MUTATION_RATE_PERTURB_BIAS 0.20
#define MUTATION_RATE_PERTURB_WEIGHT 0.20
#define MUTATION_RATE_TOGGLE_NODE 0.05
#define MUTATION_RATE_TOGGLE_CONNECTION 0.05

#define NODE_GENE_MAX_BIAS_PERTURBATION 5.0

#define CONNECTION_GENE_INITIAL_WEIGHT 1.0
#define CONNECTION_GENE_MAX_WEIGHT_PERTURBATION 5.0

#define GENOME_NUM_INPUT_NODES 2
#define GENOME_NUM_OUTPUT_NODES 1

#define POPULATION_SIZE 300
#define POPULATION_PURGE_COUNT 200
...
#define GENOME_COMPATIBILITY_COEFFICIENT_THREE 2.0
#define GENOME_COMPATIBILITY_THRESHOLD 5.0
